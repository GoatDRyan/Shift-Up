<nav class="fixed bottom-0 w-full bg-brand-primary border-t border-brand-secondary h-20 max-[375px]:h-16 flex justify-around items-center px-2 z-40 pb-safe shadow-[0_-4px_10px_rgba(0,0,0,0.02)]">
    ...
    <a href="shop.php" class="group flex flex-col items-center w-14 transition">
        ...
        <span class="text-[10px] font-bold text-brand-secondary group-hover:text-brand-dark transition-colors <?= $current_page == 'shop.php' ? '!text-brand-dark' : '' ?>"><?= $t['nav_shop'] ?></span>
    </a>
    ...
    <a href="defis.php" class="group flex flex-col items-center w-14 transition">
        ...
        <span class="text-[10px] font-bold text-brand-secondary group-hover:text-brand-dark transition-colors <?= $current_page == 'defis.php' ? '!text-brand-dark' : '' ?>"><?= $t['nav_defs'] ?></span>
    </a>
    ...
    <a href="profil.php" class="group flex flex-col items-center w-14 transition">
        ...
        <span class="text-[10px] font-bold text-brand-secondary group-hover:text-brand-dark transition-colors <?= $current_page == 'profil.php' ? '!text-brand-dark' : '' ?>"><?= $t['nav_prof'] ?></span>
    </a>
</nav>